			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
					...
					<li class="nav-item text-center"><a
						class="nav-link link_select_color1"
						id="nav-link link_select_color1"
						href="<%=request.getContextPath()%>/shortPartTimeIndex.do">단기알바</a></li>

					<!-- 단기알바 services2 css 수정 -->
					<li class="nav-item text-center"><a
						class="nav-link link_select_color2"
						id="nav-link link_select_color2"
						href="<%=request.getContextPath()%>/dailyPartTimeIndex.do">일일알바</a></li>
					<li class="nav-item text-center"><a
						class="nav-link link_select_color3"
						href="<%=request.getContextPath()%>/review_index.ho">알바후기</a></li>
