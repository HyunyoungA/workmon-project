...
ArrayList<Image> imgList = (ArrayList<Image>) request.getAttribute("fileList");
System.out.println(imgList);
System.out.println(p.getBoardNum());
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div id="notice_detail_wrap">
		<form class="big"
			action="<%=request.getContextPath()%>/shortpartTimeUpdate.st"
			...
			<div class="readSumWrap_clear">
				<input type="hidden" name="boardNum" value="<%=p.getBoardNum()%>"
						...
						<div class="tbRow_clear">
							<div class="tbCol">
								...
								<dl>
									<dt>경력</dt>
									<dt>
										<strong class="col_1"><input type="text"
											name="career" value="<%=p.getCareer()%>"></strong>
									</dt>
								</dl>
								<dl>
									<dt>학력</dt>
									<dt>
										<strong class="col_1"><input type="text"
											name="educationLevel" value="<%=p.getEducationLevel()%>"></strong>
									</dt>
								</dl>
								<dl>
									<dt>우대</dt>
									<dt>
										<strong class="col_1"><input type="text"
											name="prefer" value="<%=p.getPrefer()%>"></strong>
									</dt>
								</dl>
							</div>
							<div class="tbCol">
								...
								<dl class="tbList">
									...
									<dt>
										<strong class="col_1"><input type="text"
											name="workPeriod" value="<%=p.getWorkPeriod()%>"></strong>
									<dt>
								</dl>
								<dl>
									<dt>급여</dt>
									<dt>
										<em class="dotum"><input type="text" name="salary"
											value="<%=p.getSalary()%>"></em>
									<dt>
								</dl>
								<dl>
									<dt>지역</dt>
									<dd>
										<input type="text" name="area" value="<%=p.getArea()%>">
									</dd>
								</dl>
							</div>
						</div>
						...
						<div>
							<div style="width: 100%; height: auto;">
								...
								<div id="EmployImgArea"
									...
									<img
										src="<%if (!imgList.isEmpty() && imgList != null) {%><%=request.getContextPath()%>/img_uploadFiles/<%=imgList.get(1).getReName()%><%}%>"
										id="EmployImg" style="width: 100%; height: auto;">
								</div>
								<div id="fileArea">
						...
						<div class="tbRow_clear_1">
							<div class="tbCol_coInfo">
								<dl class="tbList_1">
									...
									<dt>대표자명</dt>
									<dd>
										<span class="tahoma">4,100</span>명
									</dd>
									<dt>회사/점포주소</dt>
									<dd>
										<span class="tahoma">1990</span>년 (<span class="tahoma">33</span>년차)
									</dd>
								</dl>
							</div>
						</div>
			...
			<div class="supportDiv">
				<button class="support" type="submit">수정하기</button>
				<input class="support" type="button"
					onclick="location.href='<%=request.getContextPath()%>/shortPartTimeIndex.do'"
					value="취소하기">
			</div>
		</form>
	</div>
