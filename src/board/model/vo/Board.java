...
public class Board {
	...
	public Board(int boardNum, String boardTitle, String boardContent, Date boardDate, int hits, int boardType,
	...
	public Board(int boardNum, String boardTitle, String boardContent, Date boardDate, int hits, String userId) {
		super();
		this.boardNum = boardNum;
		this.boardTitle = boardTitle;
		this.boardContent = boardContent;
