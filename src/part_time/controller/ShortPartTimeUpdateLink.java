 ...
 */
@WebServlet("/shortUpdate.su")
public class ShortPartTimeUpdateLink extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ShortPartTimeUpdateLink() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("WEB-INF/views/part_time/short_part_time_update.jsp").forward(request, response);
