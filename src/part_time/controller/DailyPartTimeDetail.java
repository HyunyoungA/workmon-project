...
/**
 * Servlet implementation class DailyPartTimeDetail
 */
@WebServlet("/dailyDetail.bo")
public class DailyPartTimeDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DailyPartTimeDetail() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (partTime != null & imgList != null && company != null) {
			...
			page = "WEB-INF/views/part_time/daily_part_time_Detail.jsp";
		} else {
