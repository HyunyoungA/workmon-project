...
/**
 * Servlet implementation class DailyPartTimeIndex
 */
@WebServlet("/dailyPartTimeIndex.do")
public class DailyPartTimeIndex extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DailyPartTimeIndex() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String page = null;
		if (list != null) {
			page = "WEB-INF/views/part_time/daily_Part_Time_Index.jsp";
