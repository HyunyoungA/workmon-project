...
/**
 * Servlet implementation class ShortpartTimeJob
 */
@WebServlet("/shortpartTimeJob.st")
public class ShortpartTimeInsert extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ShortpartTimeInsert() {
		super();
