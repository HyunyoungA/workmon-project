...
/**
 * Servlet implementation class DailypartTimeUpdate
 */
@WebServlet("/dailypartTimeUpdate.dt")
public class DailypartTimeUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DailypartTimeUpdate() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (ServletFileUpload.isMultipartContent(request)) {
			...
			System.out.println(imgList + "업데이트 서블릿에 imglist 객체 가져오는데 이거 몇개 있나 확인");
