...
/**
 * Servlet implementation class ShortPartTimeDelete
 */
@WebServlet("/shortPartTimeDelete.sd")
public class ShortPartTimeDelete extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ShortPartTimeDelete() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (result > 0) {
			...
			request.getRequestDispatcher("shortPartTimeIndex.do").forward(request, response);
		} else {
